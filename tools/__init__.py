...
writes ``from tools import ...``, Python runs this file first. Its job is
...
With this file they can simply write:
    ...
    from tools import ToolRegistry, build_default_registry, BaseTool
...
# __all__ controls what gets exported when someone writes "from tools import *".
