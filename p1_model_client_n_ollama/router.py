"""
Tinker Model Client — ModelRouter

This is the public API surface that all other Tinker components call.
It hides:
  - which machine/model handles each agent role
...
-----
    ...
    router = ModelRouter()           # uses env-var defaults
    await router.start()
